...
public class ReceivedRequestsNotification {

    String notificationID, userSenderID, owner_userID, owner_Username, bookName, states,date;


    public ReceivedRequestsNotification() {
    }

    public ReceivedRequestsNotification(String userSenderID, String owner_userID, String owner_Username, String bookName, String states, String date) {

...
public class Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view_user_id = intent.getStringExtra("user_id");
        ...
        if (view_user_id == null){
            ...
            setDataToProfile_FromViewActivity();
        }
...
//                            }
    ...
    private void setDataToProfile_FromViewActivity() {
        daoProfile.get().addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot profilesnap : snapshot.getChildren()) {
                    ...
                    if (view_user_id.equals(load_profile_info.getUserId())) {

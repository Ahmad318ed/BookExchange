    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Request request=(Request) getIntent().getSerializableExtra("request");
         ...
         String userEmail=request.getBookSellerEmail();
          ...
          userId=request.getBookSellerId();
        ...
        btnGoToProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ViewRequestActivity.this,Profile.class);
                ...
                for (DataSnapshot profilesnap : snapshot.getChildren()) {
                    ...
                    if (userId.equals(profile.getUserId())) {
                        ...
                        if (profile.getImg() != null){
                            Glide.with(ViewRequestActivity.this).load(profile.getImg()).fitCenter().centerCrop().into(user_image);

                        }else{
                            Glide.with(ViewRequestActivity.this).load(getDrawable(R.drawable.default_profile_img)).fitCenter().centerCrop().into(user_image);
                    ...
                    if (userId.equals(load_profile_info.getUserId())) {
                        ...
                        if (load_profile_info.getFacebook_link().equals("")) {
                            ...
                            btnFacebook.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Toast.makeText(ViewRequestActivity.this, "invalid facebook link", Toast.LENGTH_SHORT).show();
                                }
                            });
                        ...
                        if (load_profile_info.getInstagram_link().equals("")) {
                            ...
                            btnInstagram.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Toast.makeText(ViewRequestActivity.this, "invalid instagram link", Toast.LENGTH_SHORT).show();
                                }
                            });
